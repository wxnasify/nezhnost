...
const products = {
    1: { name: "НЕЖНОСТЬ", price: 6000, description: "АВТОРСКИЙ БУКЕТ ДЛЯ ОСЕННЕГО НАСТРОЕНИЯ", composition: ["РОЗЫ", "КУСТОВЫЕ ГВОЗДИКИ", "ЭУСТОМА", "ЭВКАЛИПТ"], image: "products/товар (1).jpg" },
    2: { name: "РОЗОВОЕ ЧУДО", price: 3000, description: "НЕЖНОЕ СОВЕРШЕНСТВО", composition: ["РОЗЫ", "ГИПСОФИЛА", "ФРЕЗИЯ", "ЭВКАЛИПТ"], image: "products/товар (2).jpg" },
    3: { name: "ЗАКАТ", price: 2700, description: "АВТОРСКАЯ КОМПОЗИЦИЯ В ЯРКО-КРАСНЫХ ТОНАХ", composition: ["КРАСНЫЕ РОЗЫ", "АЛЬСТРОМЕРИЯ", "ГВОЗДИКИ", "КРАСНЫЙ ЭВКАЛИПТ"], image: "products/товар (3).jpg" },
    4: { name: "ЛЕТО КРАСНОЕ", price: 3000, description: "АВТОРСКАЯ КОМПОЗИЦИЯ В ЯРКИХ СОЛНЕЧНЫХ ТОНАХ", composition: ["ПОДСОЛНУХИ", "РОМАШКИ", "ГВОЗДИКИ", "ЗЕЛЕНЬ"], image: "products/товар (4).jpg" },
    5: { name: "НЕЖНОЕ УТРО", price: 2600, description: "ВОЗДУШНЫЕ КУСТОВЫЕ РОЗЫ", composition: ["КУСТОВЫЕ РОЗЫ", "ГИПСОФИЛА", "ЭВКАЛИПТ"], image: "products/товар (5).jpg" },
    6: { name: "СУМЕРКИ", price: 2500, description: "АВТОРСКАЯ КОМПОЗИЦИЯ В СИРЕНЕВЫХ ТОНАХ", composition: ["СИРЕНЬ", "ЛАВАНДА", "ЭУСТОМА", "ЭВКАЛИПТ"], image: "products/товар (6).jpg" }
};
